...
///////////////////////////
	...
	if(distance1 < limit1)    
	{
		...
		{car_stop();Delay(100);car_rightstop(); Delay(100);car_stop();Delay(100);}
		if(distance3 < distance2)
		{car_stop();Delay(100);car_leftstop(); Delay(150);car_stop();Delay(100);}
		else
		{car_stop();Delay(100);}
	} 
 	if(distance2 < limit2)
	{car_stop();Delay(100);car_rightstop(); Delay(150);car_stop();Delay(100);}             
  if(distance3 < limit3)
	{car_stop();Delay(100);car_leftstop(); Delay(200);car_stop();Delay(100);}
	}
